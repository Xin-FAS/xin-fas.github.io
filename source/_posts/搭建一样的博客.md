...
html[data-user-color-scheme="light"] .markdown-body p code, li code{
    color: #c7254e;
}
/* 暗色 */
...
html[data-user-color-scheme="dark"] .markdown-body p code, li code{
    color: #f3b37f;
}
```
...
在线制作字符码：http://patorjk.com/software/taag，复制想要的
